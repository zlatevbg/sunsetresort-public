...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'select-room' => [
            ...
            'numeric' => 'Please select unit type.',
            'min' => 'Please select unit type.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'consent' => 'General terms',
        'company' => 'Company',
        'eik' => 'ID number',
        'vat' => 'VAT number',
        'address' => 'Address',
        'city' => 'City',
        'mol' => 'Person in charge',
        'invoice' => '"Yes, I would like to receive a company invoice"',
    ],
