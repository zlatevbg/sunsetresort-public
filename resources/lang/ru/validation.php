...
return [
    ...
    */
    ...
    'custom' => [
        'dfrom' => [
            'before_or_equal' => 'Строка :attribute должна быть датой до или равной :date.',
        ],
        'g-recaptcha-response' => [
            'required' => 'Пожалуйста нажмите на "Я не робот"!',
        ],
        'select-room' => [
            'required' => 'Выберите номер.',
            'numeric' => 'Выберите номер.',
            'min' => 'Выберите номер.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'meals' => 'Питание',
        'guests' => 'Число гостей',
        'consent' => 'Общие условия',
        'company' => 'Компания',
        'eik' => 'Идентификационный номер',
        'vat' => 'Номер НДС',
        'address' => 'Адрес',
        'city' => 'Город',
        'mol' => 'Имя и фамилия управляющего',
        'invoice' => '"Да, я хотел бы получить счет"',
    ],
