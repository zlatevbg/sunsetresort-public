...
<div class="magnific-popup">
    ...
    @if (isset($page))
    {!! Form::model($page, ['method' => 'put', 'url' => \Locales::route('rooms/update'), 'id' => 'edit-category-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('rooms/store'), 'id' => 'create-category-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @endif
