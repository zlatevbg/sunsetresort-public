...
<div class="magnific-popup">
    ...
    @if (isset($page))
    {!! Form::model($page, ['method' => 'put', 'url' => \Locales::route('banners/update'), 'id' => 'edit-page-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('banners/store'), 'id' => 'create-page-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @endif
    ...
    <div class="form-group">
        {!! Form::label('input-slogan', trans(\Locales::getNamespace() . '/forms.sloganLabel')) !!}
        {!! Form::text('slogan', null, ['id' => 'input-slogan', 'class' => 'form-control', 'placeholder' => trans(\Locales::getNamespace() . '/forms.sloganPlaceholder')]) !!}
    </div>
    ...
    <div class="form-group">
        {!! Form::label('input-identifier', trans(\Locales::getNamespace() . '/forms.identifierLabel')) !!}
        {!! Form::text('identifier', null, ['id' => 'input-identifier', 'class' => 'form-control', 'placeholder' => trans(\Locales::getNamespace() . '/forms.identifierPlaceholder')]) !!}
    </div>

    <div class="form-group">
        {!! Form::checkboxInline('is_video', 1, null, ['id' => 'input-is_video'], trans(\Locales::getNamespace() . '/forms.isVideoOption'), ['class' => 'checkbox-inline']) !!}
    </div>
