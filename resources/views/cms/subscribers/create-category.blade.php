...
<div class="magnific-popup">
    ...
    @if (isset($subscriber))
    {!! Form::model($subscriber, ['method' => 'put', 'url' => \Locales::route('subscribers/update'), 'id' => 'edit-subscriber-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('subscribers/store'), 'id' => 'create-subscriber-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @endif
