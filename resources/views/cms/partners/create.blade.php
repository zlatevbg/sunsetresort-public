...
<div class="magnific-popup">
    ...
    @if (isset($partner))
    {!! Form::model($partner, ['method' => 'put', 'url' => \Locales::route('partners/update'), 'id' => 'edit-partner-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('partners/store'), 'id' => 'create-partner-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @endif
