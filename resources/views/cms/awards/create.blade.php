...
<div class="magnific-popup">
    ...
    @if (isset($award))
    {!! Form::model($award, ['method' => 'put', 'url' => \Locales::route('awards/update'), 'id' => 'edit-award-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('awards/store'), 'id' => 'create-award-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @endif
