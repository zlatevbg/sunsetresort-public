...
<div class="magnific-popup">
    ...
    <div class="text-center">
        {!! Form::open(['method' => 'put', 'url' => \Locales::route('transactions/refund', ['transaction' => $transaction->id]), 'id' => 'refund-transaction-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    ...
    <br><br>
    <div class="text-center">
        {!! Form::open(['method' => 'delete', 'url' => \Locales::route('transactions/cancelled'), 'id' => 'cancelled-transaction-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
        {!! Form::hidden('table', $table, ['id' => 'input-table']) !!}
