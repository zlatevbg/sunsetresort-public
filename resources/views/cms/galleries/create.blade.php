...
<div class="magnific-popup">
    ...
    @if (isset($gallery))
    {!! Form::model($gallery, ['method' => 'put', 'url' => \Locales::route('galleries/update'), 'id' => 'edit-gallery-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('galleries/store'), 'id' => 'create-gallery-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @endif
