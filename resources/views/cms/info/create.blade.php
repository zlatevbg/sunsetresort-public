...
<div class="magnific-popup">
    ...
    @if (isset($page))
    {!! Form::model($page, ['method' => 'put', 'url' => \Locales::route('info/update'), 'id' => 'edit-page-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('info/store'), 'id' => 'create-page-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @endif
    ...
    <div class="form-group">
        {!! Form::checkboxInline('is_map', 1, null, ['id' => 'input-is_map'], trans(\Locales::getNamespace() . '/forms.isMapOption'), ['class' => 'checkbox-inline']) !!}
    </div>
