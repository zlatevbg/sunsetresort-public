...
<div class="magnific-popup">
    ...
    @if (isset($page))
    {!! Form::model($page, ['method' => 'put', 'url' => \Locales::route('info/update'), 'id' => 'edit-category-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @else
    {!! Form::open(['url' => \Locales::route('info/store'), 'id' => 'create-category-form', 'data-ajax-queue' => 'sync', 'class' => 'ajax-lock', 'role' => 'form']) !!}
    @endif
