<div id="header">
    ...
    <div class="facebook-nav">
        <a class="btn btn-primary" href="https://www.facebook.com/SunsetResortPomorie"><span>{{ trans(\Locales::getNamespace() . '/messages.facebookTitle') }} </span>{!! HTML::image(\App\Helpers\autover('/img/' . \Locales::getNamespace() . '/facebook-nav.png'), trans(\Locales::getNamespace() . '/messages.facebookTitle')) !!}</a>
    </div>
